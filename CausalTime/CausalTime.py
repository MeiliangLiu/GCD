...
###########
#Note: The method for calculating AUROC and AUPRC in the CausalTime dataset differs
# from that used in other datasets. Specifically, only the upper-left p/2 × p/2 submatrix
# of the inferred causal matrix is used in the evaluation. For more details, please refer
# to the CausalTime paper.
